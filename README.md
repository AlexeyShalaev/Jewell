...
```
- Шаг 7 — Защита приложения [Let’s Encrypt](https://www.digitalocean.com/community/tutorials/how-to-create-a-self-signed-ssl-certificate-for-nginx-in-ubuntu-20-04-1)
